...
<body>
  ...
  <section>
    ...
    while ($produto = $stmt->fetch()) {
      ?>
      <div class="card">
        <a href="carrinho.php"><img src="<?php echo $produto['imagem']; ?>" alt="<?php echo $produto['nome']; ?>"></a>
        <h3><?php echo <span class="math-inline">produto\['nome'\]; ?\></h3\>
        <p\>R</span> <?php echo number_format($produto['preco'], 2, ',', '.'); ?></p>
